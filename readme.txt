...
Donate link: http://www.webternals.com/projects/admangler/
Tags: Ads
...
visiting <a href="http://www.webternals.com/projects/admangler">http://www.webternals.com/projects/admangler</a>. AdMangler Pro
is currently under development and available only as a pre order. AdMangler Pro is slated for release sometime in June 2013. 
...
1. (Not Yet Working) To display the AdMangler Front-end panel you will need to create an empty page and place the following tag in that page: [AdMangler type="Panel"]
...
* Bug fix for unexpected output during activation
* Removed the items that have some missing functionality

= 0.0.8.4.Alpha =
* Database update was missed in the last version this updates fixes it
...
* The panel has not been implemented yet but there is a place holder page for the panel. (This is were advertisers will manage their accounts)
* Bug fixes
